class Connection {
    constructor(cell1, cell2, value = 0, directed = false) {
        this.cell1 = cell1;
        this.cell2 = cell2;
        this.value = value;
    ...
    render_line() {
        ...
        rectMode(CENTER);
        fill(255);
        rect((this.cell1.x + this.cell2.x) / 2, (this.cell1.y + this.cell2.y) / 2, 40, 20);
        text(this.value, (this.cell1.x + this.cell2.x) / 2 - 18, (this.cell1.y + this.cell2.y) / 2 + ((textAscent() + textDescent()) / 4));
        fill(0);
    }
